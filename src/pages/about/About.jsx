  ...
  return (
    <>
      ...
      <section className='about'>
        ...
        <Tile className={'tile about__tile4 animate__animated  animate__slideInRight'}
              icon={<FaUniversity />} title={t('aboutPage.education.title')}
              subtitle={t('aboutPage.education.subtitle')}
              linkIcon={<TbCircleArrowRight />} />

        <Tile className={'tile about__tile5 animate__animated  animate__slideInLeft'}
              icon={<FaLinkedin />}
              linkIcon={<TbCircleArrowRight />} />

        <Tile className={'tile about__tile6 animate__animated  animate__zoomIn'}
              title={t('aboutPage.contact.title')}
              subtitle={t('aboutPage.contact.subtitle')}
              linkIcon={<TbCircleArrowRight />} />

        <Tile className={'tile about__tile7 animate__animated  animate__slideInRight'}
              icon={<BsPersonVcard />}
